...
(cl:defmethod cl:initialize-instance :after ((m <TrackCone>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TrackCone)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ytu_racing_msgs-msg:<TrackCone> is deprecated: use ytu_racing_msgs-msg:TrackCone instead.")))
...
(cl:defmethod type-val ((m <TrackCone>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ytu_racing_msgs-msg:type-val is deprecated.  Use ytu_racing_msgs-msg:type instead.")
  (type m))
