...
(cl:defmethod cl:initialize-instance :after ((m <Command>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Command)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ytu_racing_msgs-msg:<Command> is deprecated: use ytu_racing_msgs-msg:Command instead.")))

(cl:ensure-generic-function 'theta_l-val :lambda-list '(m))
(cl:defmethod theta_l-val ((m <Command>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ytu_racing_msgs-msg:theta_l-val is deprecated.  Use ytu_racing_msgs-msg:theta_l instead.")
  (theta_l m))

(cl:ensure-generic-function 'theta_r-val :lambda-list '(m))
(cl:defmethod theta_r-val ((m <Command>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ytu_racing_msgs-msg:theta_r-val is deprecated.  Use ytu_racing_msgs-msg:theta_r instead.")
  (theta_r m))

(cl:ensure-generic-function 'torque_fl-val :lambda-list '(m))
(cl:defmethod torque_fl-val ((m <Command>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ytu_racing_msgs-msg:torque_fl-val is deprecated.  Use ytu_racing_msgs-msg:torque_fl instead.")
  (torque_fl m))

(cl:ensure-generic-function 'torque_fr-val :lambda-list '(m))
(cl:defmethod torque_fr-val ((m <Command>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ytu_racing_msgs-msg:torque_fr-val is deprecated.  Use ytu_racing_msgs-msg:torque_fr instead.")
  (torque_fr m))

(cl:ensure-generic-function 'torque_rl-val :lambda-list '(m))
(cl:defmethod torque_rl-val ((m <Command>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ytu_racing_msgs-msg:torque_rl-val is deprecated.  Use ytu_racing_msgs-msg:torque_rl instead.")
  (torque_rl m))

(cl:ensure-generic-function 'torque_rr-val :lambda-list '(m))
(cl:defmethod torque_rr-val ((m <Command>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ytu_racing_msgs-msg:torque_rr-val is deprecated.  Use ytu_racing_msgs-msg:torque_rr instead.")
  (torque_rr m))
