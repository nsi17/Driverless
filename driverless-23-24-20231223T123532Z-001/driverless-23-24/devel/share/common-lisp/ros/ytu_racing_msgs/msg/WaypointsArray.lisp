...
(cl:defclass <WaypointsArray> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (waypoints
    :reader waypoints
    :initarg :waypoints
    :type (cl:vector ytu_racing_msgs-msg:Waypoint)
   :initform (cl:make-array 0 :element-type 'ytu_racing_msgs-msg:Waypoint :initial-element (cl:make-instance 'ytu_racing_msgs-msg:Waypoint)))
...
(cl:defmethod cl:initialize-instance :after ((m <WaypointsArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'WaypointsArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ytu_racing_msgs-msg:<WaypointsArray> is deprecated: use ytu_racing_msgs-msg:WaypointsArray instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <WaypointsArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ytu_racing_msgs-msg:header-val is deprecated.  Use ytu_racing_msgs-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'waypoints-val :lambda-list '(m))
(cl:defmethod waypoints-val ((m <WaypointsArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ytu_racing_msgs-msg:waypoints-val is deprecated.  Use ytu_racing_msgs-msg:waypoints instead.")
  (waypoints m))
...
(cl:defmethod preliminaryLoopClosure-val ((m <WaypointsArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ytu_racing_msgs-msg:preliminaryLoopClosure-val is deprecated.  Use ytu_racing_msgs-msg:preliminaryLoopClosure instead.")
...
(cl:defmethod loopClosure-val ((m <WaypointsArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ytu_racing_msgs-msg:loopClosure-val is deprecated.  Use ytu_racing_msgs-msg:loopClosure instead.")
  (loopClosure m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <WaypointsArray>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'waypoints)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'ytu_racing_msgs-msg:Waypoint))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<WaypointsArray>)))
  ...
  "ytu_racing_msgs/WaypointsArray")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'WaypointsArray)))
  "Returns string type for a message object of type 'WaypointsArray"
  "ytu_racing_msgs/WaypointsArray")
