...
(cl:defclass <Track> (roslisp-msg-protocol:ros-message)
  ((cones
    :reader cones
    :initarg :cones
    :type (cl:vector ytu_racing_msgs-msg:TrackCone)
   :initform (cl:make-array 0 :element-type 'ytu_racing_msgs-msg:TrackCone :initial-element (cl:make-instance 'ytu_racing_msgs-msg:TrackCone))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <Track>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Track)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ytu_racing_msgs-msg:<Track> is deprecated: use ytu_racing_msgs-msg:Track instead.")))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Track>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'cones)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'ytu_racing_msgs-msg:TrackCone))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Track>)))
  ...
  (cl:format cl:nil "ytu_racing_msgs/TrackCone[] cones~%================================================================================~%MSG: ytu_racing_msgs/TrackCone~%float64 x~%float64 y~%~%string type~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Track)))
  "Returns full string definition for message of type 'Track"
  (cl:format cl:nil "ytu_racing_msgs/TrackCone[] cones~%================================================================================~%MSG: ytu_racing_msgs/TrackCone~%float64 x~%float64 y~%~%string type~%~%"))
